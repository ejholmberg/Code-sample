...
# Function to process Medicaid dual-eligible data from CMS Excel file
...
# Cleaning required: consolidating redundant columns, selecting columns, converting strings into numeric values
